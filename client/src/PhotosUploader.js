  ...
  return (
    <>
      ...
      <div className="mt-2 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
          ...
          addedPhotos.map((link) => (
            <div key={link} className="h-32 flex relative">
              ...
              <button
                ...
                className="cursor-pointer absolute bottom-1 right-1 text-white bg-black bg-opacity-60 rounded-xl py-2 px-3"
              >
                <svg
              ...
              <button
                ...
                className="cursor-pointer absolute bottom-1 left-1 text-white bg-black bg-opacity-60 rounded-xl py-2 px-3"
              >
                {link === addedPhotos[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
        ...
        <label className="cursor-pointer flex items-center justify-center gap-1 border bg-transparent rounded-2xl p-2 text-xl text-gray-600">
          <input
            type="file"
            multiple
            className="hidden"
